...
def get_config():
    ...
    conf.job_name = 'test-20200301-4@2-depth-01'
    conf.train_list = 'anno/DEPTH/4@2_train.txt'
    conf.val_list = ['anno/DEPTH/4@2_dev.txt',
                     'anno/DEPTH/4@1_dev.txt',
                     'anno/DEPTH/4@3_dev.txt']
    conf.test_list = ['anno/DEPTH/4@2_dev.txt',
                      'anno/DEPTH/4@2_test.txt']
