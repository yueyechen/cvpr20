...
def get_config():
    ...
    conf.job_name = 'test-20200301-4@3-depth-01'
    conf.train_list = 'anno/DEPTH/4@3_train.txt'
    conf.val_list = ['anno/DEPTH/4@3_dev.txt',
                     'anno/DEPTH/4@1_dev.txt',
                     'anno/DEPTH/4@2_dev.txt']
    conf.test_list = ['anno/DEPTH/4@3_dev.txt',
                      'anno/DEPTH/4@3_test.txt']
...
# --------------------Training Config ------------------------
    ...
    conf.test = edict()
    conf.test.save_name = ['4@3-dev-single-best-acc-loss', '4@3-test-single-best-acc-loss']
    conf.test.epoch = 2
