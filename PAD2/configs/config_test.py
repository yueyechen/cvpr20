...
def get_config():
    ...
    conf.job_name = 'test-20200301-4@3-ir-04'
    conf.train_list = 'anno/IR/4@3_train_relabel.txt'
    conf.val_list = ['anno/IR/4@3_dev.txt',
                     'anno/IR/4@1_dev.txt',
                     'anno/IR/4@2_dev.txt']
    conf.test_list = ['anno/IR/4@3_dev.txt',
                      'anno/IR/4@3_test.txt']
    ...
    conf.model.network.num_classes = 1 if conf.model.use_relabel else 2

# --------------------Training Config ------------------------
    # if training:
    conf.train.epoches = 30
    ...
    conf.test = edict()
    conf.test.save_name = [
        '4@3-dev-single-best-acc-loss', '4@3-test-single-best-acc-loss']
