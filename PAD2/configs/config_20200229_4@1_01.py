...
# --------------------Training Config ------------------------
    ...
    conf.test = edict()
    conf.test.save_name = ['4@1-dev-single-best-acc-loss', '4@1-test-single-best-acc-loss']
    conf.test.epoch = 44
